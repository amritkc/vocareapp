...
export function AppointmentHoverCard({
  ...
  if (!mounted) {
    // Return just the children without the hover card functionality
    return <>{children}</>;
  }
        ...
        <div className="space-y-2">
          ...
          <div 
            className={cn(
              ...
              appointment.color === "green" ? "border-green-500" : 
              appointment.color === "purple" ? "border-purple-500" : 
              "border-blue-500"
            )}
          >
            {appointment.title}
          ...
          <div className="flex items-center text-sm">
            ...
            <span>
              {format(appointment.date, "EEEE, dd. MMMM yyyy", { locale: de })}
            </span>
          </div>
